...
const zones = () =>
  (zonesPromise ??= import("../assets/ne_10m_time_zones.json"));
...
export const findTimeZone = async (
...
const calculateUtc = async (
  dateTime: DateTime,
  coordinates: GlobalCoordinates,
): Promise<DateTime> => utcAtOffset(dateTime, await findTimeZone(coordinates));
